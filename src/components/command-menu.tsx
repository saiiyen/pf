...
//import { saiiyenMark, getMarkSVG } from "./saiiyen-mark";
//import { getWordmarkSVG } from "./saiiyen-wordmark";
...
const SAIIYEN_LINKS: CommandLinkItem[] = [
  {
    title: "About",
    href: "/#about",
    icon: LetterTextIcon,
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="min-h-80">
          ...
          <CommandGroup heading="Brand Assets">
            ...
            <CommandItem
              onSelect={() => handleOpenLink("/blog/saiiyen-brand")}
            >
              <TriangleDashedIcon />
              Brand Guidelines
            </CommandItem>
            ...
            <CommandItem asChild>
              <a href="https://assets.saiiyen.com/saiiyen-brand.zip" download>
                <DownloadIcon />
